...
public class ApiV1_15 extends BaseApiExport {
    public Proxy proxy;
    public Collection<MemberV1_15> members;
    public Collection<PlanEntityBefore_3_00> plans;

    public static class Proxy extends ProxyBaseV1_15 {
        public LoggingMode loggingMode = LoggingMode.NONE;
        public List<Endpoint> endpoints;
        @JsonProperty("load_balancing")
        public LoadBalancer loadBalancer;
        public ApiV1_15.Cors cors;
    }

    @JsonIgnoreProperties("errorStatusCode")
    public static class Cors extends io.gravitee.definition.model.Cors {
    }
}
