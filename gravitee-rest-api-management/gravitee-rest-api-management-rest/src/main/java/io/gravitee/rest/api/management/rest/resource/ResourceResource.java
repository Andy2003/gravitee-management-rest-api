...
public class ResourceResource {
    ...
    @ApiResponse(responseCode = "200", description = "Resource plugin",
            content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = PluginEntity.class)))
