...
public class RoleUsersResource extends AbstractResource {
    ...
    @ApiResponse(responseCode = "204", description = "List of user's memberships",
    ...
    public Response addRoleToUser(
            @Parameter(name = "scope", required = true, schema = @Schema(allowableValues = {"ORGANIZATION", "ENVIRONMENT"}))
