...
public class ClientRegistrationProvidersResource extends AbstractResource {
    ...
    @ApiResponse(responseCode = "200", description = "List client registration providers",
            content = @Content(mediaType = MediaType.APPLICATION_JSON, array = @ArraySchema(schema = @Schema(implementation = ClientRegistrationProviderListItem.class))))
    ...
    @ApiResponse(responseCode = "201", description = "Client registration provider provider successfully created",
            content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = ClientRegistrationProviderEntity.class)))
    @ApiResponse(responseCode = "500", description = "Internal server error")
    public Response createClientRegistrationProvider(
            @Parameter(name = "identity-provider", required = true) @Valid @NotNull NewClientRegistrationProviderEntity newClientRegistrationProviderEntity) {
